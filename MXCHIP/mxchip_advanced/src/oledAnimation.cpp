...
void AnimationController::renderFrameToBuffer(unsigned char *screenBuffer,
                                              char *image) {
  int columnPad = 3;
  int colLimit = 8;
