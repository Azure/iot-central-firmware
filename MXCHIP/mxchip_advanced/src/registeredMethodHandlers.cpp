...
int dmCountdown(const char *payload, size_t size) {
  ...
  for (int32_t iter = countFrom; iter >= 0; iter--) {
    ...
    AzureIOTClient *hubClient =
        ((TelemetryController *)Globals::loopController)->getClient();
    ...
    for (int decColour = 0; decColour < 3; decColour += 1) {
      ...
      for (int i = 0; i < 255; i += 1) {
        ...
        Globals::sensorController.setLedColor(rgbColour[0], rgbColour[1],
                                              rgbColour[2]);
        delay(3);
      }
      if (hubClient != NULL) {
    ...
    if (hubClient != NULL) {
      int n = snprintf(counterString, STRING_BUFFER_128 - 1,
                       "{\"countdown\":{\"value\": %ld}}", iter);
      counterString[n] = 0;
...
int fanSpeedDesiredChange(const char *message, size_t size) {
  ...
  Screen.clean();
  for (int i = 0; i < 2; i++) {
    AnimationController::renderFrameToBuffer(
        buffer + (i * OLED_SINGLE_FRAME_BUFFER), fan[i]);
  }
...
void animateCircular(char **source, unsigned length) {
  ...
  for (unsigned i = 0; i < length; i++) {
    AnimationController::renderFrameToBuffer(
        buffer + (i * OLED_SINGLE_FRAME_BUFFER), source[i]);
  }
...
int voltageDesiredChange(const char *message, size_t size) {
  ...
  char voltage3[] = {'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G',
                     'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G',
                     'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G',
                     'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G',
                     'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G',
...
int currentDesiredChange(const char *message, size_t size) {
  ...
  char current2[] = {'g', 'g', 'g', 'g', 'g', 'g', '.', '.', 'g', 'g', 'g',
                     'g', 'g', 'g', '.', '.', 'g', 'g', 'g', 'g', 'g', 'g',
                     '.', '.', 'g', 'g', 'g', 'g', 'g', 'g', '.', '.', 'g',
                     'g', 'g', 'g', 'g', 'g', '.', '.', 'g', 'g', 'g', 'g',
                     'g', 'g', '.', '.', 'g', 'g', 'g', 'g', 'g', 'g', '.',
  ...
  char current3[] = {'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g',
                     'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g',
                     'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g',
                     'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g',
                     'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g',
