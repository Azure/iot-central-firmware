...
if(${use_installed_dependencies})
    ...
    if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/deps/c-utility/src")
        message(FATAL_ERROR "c-utility directory is empty. Please pull in all submodules if building unit tests.")
    endif()
    set(SHARED_UTIL_SRC_FOLDER "${CMAKE_CURRENT_LIST_DIR}/deps/c-utility/src")
    set(SHARED_UTIL_FOLDER "${CMAKE_CURRENT_LIST_DIR}/deps/c-utility")
