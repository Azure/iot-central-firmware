...
int mbedtls_ssl_fetch_input( mbedtls_ssl_context *ssl, size_t nb_want )
{
    ...
    if( ssl->conf->transport == MBEDTLS_SSL_TRANSPORT_DATAGRAM )
    {
        ...
        else
        {
            ...
            MBEDTLS_SSL_DEBUG_MSG( 2, ( "f_recv_timeout: %u ms", timeout ) );
...
#endif
    {
        MBEDTLS_SSL_DEBUG_MSG( 2, ( "in_leftx: %d, nb_want: %d",
                       ssl->in_left, nb_want ) );
        ...
        while( ssl->in_left < nb_want )
        {
            ...
            else
            {
                if( ssl->f_recv_timeout != NULL )
                {
                    MBEDTLS_SSL_DEBUG_MSG( 2, ("timeoutzz %d",ssl->conf->read_timeout) );
            ...
            MBEDTLS_SSL_DEBUG_MSG( 2, ( "in_leftz: %d, nb_want: %d",
                                        ssl->in_left, nb_want ) );
            MBEDTLS_SSL_DEBUG_RET( 2, "ssl->f_recv(_timeout)", ret );
...
static int ssl_prepare_record_content( mbedtls_ssl_context *ssl )
{
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "dumped the input record from network (%d)", ssl->in_msglen ) );
...
static int ssl_consume_current_message( mbedtls_ssl_context *ssl )
{
    ...
    if( ssl->in_hslen != 0 )
    {
        ...
        if( ssl->in_hslen < ssl->in_msglen )
        {
            ...
            MBEDTLS_SSL_DEBUG_MSG( 1, ( "dumped the remaining content in record (%d)", ssl->in_msglen ) );
...
int mbedtls_ssl_parse_certificate( mbedtls_ssl_context *ssl )
{
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A1" ) );
    if( ssl->in_msgtype != MBEDTLS_SSL_MSG_HANDSHAKE )
    {
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A2" ) );
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A3" ) );
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A4" ) );

    mbedtls_x509_crt_init( ssl->session_negotiate->peer_cert );

    i += 3;
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A5. in_hslen = %d", ssl->in_hslen ) );
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A6" ) );
    ...
    MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A7" ) );

    if( authmode != MBEDTLS_SSL_VERIFY_NONE )
    {
        MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A8" ) );
        ...
        MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A9" ) );
        if( ret != 0 )
        {
        ...
        MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A10" ) );
        ...
        MBEDTLS_SSL_DEBUG_MSG( 1, ( "PASS-A11" ) );
        if( ret != 0 )
        {
