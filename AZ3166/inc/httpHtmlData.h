...
#define HTTP_START_PAGE_HTML_ HTTP_HEADER_HTML "<body> <header> <h1 class=\"logo\">Azure IoT Central Device Config</h1> </header> <section class=\"container\"> <div id=\"content\" class=\"row\"> <div class=\"col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-4\" style=\"text-align:center;\"> \
<form action=\"/PROCESS\" method=\"get\">\
<div class=\"input-group fluid\"> <select name=\"SSID\" id=\"SSID\" style=\"width:100%;\"><option value=\"\">-- Select network or enter manually below --</option>{{networks}}</select> </div><div class=\"input-group fluid\"> <input type=\"text\" value=\"\" name=\"SSID\" placeholder=\"Manual SSID\" style=\"width:100%;\"> </div>\
...
<div class=\"input-group fluid\"> <input type=\"text\" value=\"\" name=\"CONN\" id=\"connstr\" placeholder=\"Device connection string\" style=\"width:100%;\" title=\"Copy in the device connection string from Azure IoT Central application\" required pattern=\"(hostname=|HostName=|HOSTNAME=|DeviceId=|deviceid=|DEVICEID=|SharedAccessKey=|sharedaccesskey=|SHAREDACCESSKEY=).*\"> </div><div class=\"input-group fluid\" style=\"text-align:left\"> <fieldset class=\"group\"> <legend>Select telemetry data to send</legend> <ul class=\"checkbox\"> <li><input type=\"checkbox\" name=\"TEMP\" id=\"temp\" checked><label for=\"temp\">Temperature</label></li><li><input type=\"checkbox\" name=\"ACCEL\" id=\"accel\" checked><label for=\"accel\">Accelerometer</label></li><li><input type=\"checkbox\" name=\"HUM\" id=\"hum\" checked><label for=\"hum\">Humidity</label></li><li><input type=\"checkbox\" name=\"GYRO\" id=\"gyro\" checked><label for=\"gyro\">Gyroscope</label></li><li><input type=\"checkbox\" name=\"PRES\" id=\"pres\" checked><label for=\"pres\">Pressure</label></li><li><input type=\"checkbox\" name=\"MAG\" id=\"mag\" checked><label for=\"mag\">Magnetometer</label></li></ul> </fieldset> </div><div class=\"input-group fluid\" style=\"padding-top: 20px;\"> <button type=\"submit\" class=\"primary\">Configure Device</button> </div></form> <h5>Click <a href=\"javascript:window.location.href=window.location.href\">here</a> to refresh the page if you do not see your network</h5> </div></div></section></body></html>"
